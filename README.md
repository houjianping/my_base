...
[![Methods](https://img.shields.io/badge/Methods%20%7C%20Size%20-%20901%20%7C%20121%20KB-d9534f.svg)](http://www.methodscount.com/?lib=com.androidapp.smartrefresh%3ASmartRefreshLayout%3A1.0.4)
...
compile 'com.androidapp.smartrefresh:SmartRefreshLayout:1.1.0-alpha-2'
compile 'com.androidapp.smartrefresh:SmartRefreshHeader:1.1.0-alpha-2'//没有使用特殊Header，可以不加这行
compile 'com.android.support:appcompat-v7:25.3.1'//版本 23以上（必须）

//1.0.5 当1.1.0出现问题可以回退到1.0.5.1
compile 'com.androidapp.smartrefresh:SmartRefreshLayout:1.0.5.1'
compile 'com.androidapp.smartrefresh:SmartRefreshHeader:1.0.5.1'//没有使用特殊Header，可以不加这行
compile 'com.android.support:appcompat-v7:25.3.1'//版本 23以上（必须）
...
<com.androidapp.smartrefresh.layout.SmartRefreshLayout xmlns:android="http://schemas.android.com/apk/res/android"
...
<com.androidapp.smartrefresh.layout.SmartRefreshLayout
    ...
    <com.androidapp.smartrefresh.layout.header.ClassicsHeader
        android:layout_width="match_parent"
