...
import com.siyuan.enjoyreading.ui.zone.CircleMovementMethod;
import com.siyuan.enjoyreading.widget.CommentListView;
import com.siyuan.enjoyreading.widget.FavortListView;
...
public class CommentAdapter {
    ...
    public class NameClickable extends ClickableSpan implements View.OnClickListener {
        private final FavortListView.ISpanClick mListener;
        private int mPosition;

        public NameClickable(FavortListView.ISpanClick l, int position) {
            mListener = l;
            mPosition = position;
        }
        ...
        public void updateDrawState(TextPaint ds) {
            ...
            int colorValue = mContext.getResources().getColor(R.color.color_primary);
    ...
    public class NameClickListener implements FavortListView.ISpanClick {
