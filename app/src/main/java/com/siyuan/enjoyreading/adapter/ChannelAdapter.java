...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ChannelEntity> mMyChannelItems, List<ChannelEntity> mOtherChannelItems, ChannelCallBack callback) {
                    ...
                    public boolean onLongClick(final View v) {
                        if (!isEditMode) {
                            ...
                            if (view == recyclerView.getLayoutManager().findViewByPosition(0)) {
                                mChannelCallBack.onItemLongPress();
                            }
                        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public void onItemSelected() {
            textView.setBackgroundResource(R.drawable.btn_channel_press);
        }
        ...
        public void onItemFinish() {
            textView.setBackgroundResource(R.drawable.btn_channel);
        }
    }
    ...
    public void changeEditMode(RecyclerView parent) {
        if (isEditMode) {
            cancelEditMode(parent);
        } else {
