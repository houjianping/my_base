...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        textWidth = a.getDimensionPixelSize(
                R.styleable.stl_SmartTabLayout_stl_defaultTabTextWidth, textWidth);
        ...
        this.tabViewTextWidth = textWidth;
...
//    textView.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (distributeEvenly) {
                if (tabViewTextWidth > 0) {
                    tabView.setLayoutParams(new LinearLayout.LayoutParams(tabViewTextWidth, ViewGroup.LayoutParams.MATCH_PARENT));
                } else {
