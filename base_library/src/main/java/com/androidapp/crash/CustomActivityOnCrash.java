...
public final class CustomActivityOnCrash {
    ...
    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.androidapp.crash.ERROR";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.androidapp.crash.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.androidapp.crash.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
