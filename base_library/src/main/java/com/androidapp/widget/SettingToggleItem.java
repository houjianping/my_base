...
public class SettingToggleItem extends RelativeLayout {
    ...
    public SettingToggleItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.settings_toggle_row_item, this);
    ...
    private void updateUI() {
        ...
        if (mShowBottomDiv) {
            LayoutParams layoutParams = new LayoutParams(mBottomDivView.getLayoutParams());
