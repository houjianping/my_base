...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#69DC82");
    /**
     * 关闭颜色
     */
    private int offBorderColor = Color.parseColor("#E5E5E5");
    /**
     * 灰色带颜色
     */
...
//		}
    ...
    /**
     * @param state   true 开， false 关
     * @param animate true 动画开， false 动画关
     */
    public void setToggleState(boolean state, boolean animate) {
        if (state) {
            toggleOn();
        } else {
            toggleOff();
