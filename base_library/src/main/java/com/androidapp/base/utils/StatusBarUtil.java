    ...
    public static void darkMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//5.0及以上
            ...
            if (useThemestatusBarColor) {
                activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.actionsheet_red));
            } else {
        ...
        /*if (isEnableTransparencyBar()) {
            StatusBarUtil.transparencyBar(activity);
            StatusBarUtil.setStatusBarColor(activity, android.R.color.transparent);
            StatusBarUtil.StatusBarLightMode(activity);
        }*/
    }

    public static boolean isEnableTransparencyBar() {
        return true;
    }
